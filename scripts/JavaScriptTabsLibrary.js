...
function appendStyleAndPopupViews() {
	...
	tabStyleString += "margin-left: 1rem;";
...
export function customiseTabsAndComponentsStyles(customTabsContainerStyleString, customTabStyleString, customTabContentContainerStyleString, customTabButtonsStyleString, customTabButtonsHoverStyleString, customTabButtonsPressedStyleString, customActiveTabButtonStyle) {
...
export function addSwipableTabs(containerElementID, tabsObjectsArray, tabNamesArray, onChangeTabListener, tabWidth/*notRecommended*/, tabHeight/*notRecommended*/) {
	if(!isAnvilleStyleAdded) {
		appendStyleAndPopupViews();
...
export function addSwipableTabsWithoutTabButtons(containerElementID, tabsObjectsArray, onChangeTabListener, tabWidth/*notRecommended*/, tabHeight/*notRecommended*/) {
	if(!isAnvilleStyleAdded) {
		appendStyleAndPopupViews();
...
export function addNonSwipableTabs(containerElementID, tabsObjectsArray, tabNamesArray, onChangeTabListener, tabWidth/*notRecommended*/, tabHeight/*notRecommended*/) {
	if(!isAnvilleStyleAdded) {
		appendStyleAndPopupViews();
		isAnvilleStyleAdded = true;
	}
...
export function getTabButtonsContainer(containerElementID) {
	let containerElement = document.getElementById(containerElementID);
...
export function getTab(containerElementID, tabIndex) {
	let containerElement = document.getElementById(containerElementID);
	if(containerElement.children.length >= 2) {
		if(containerElementIDs[containerElementID + "tabType"] === "nonSwipable") {
...
export function getTabContentContainer(containerElementID, tabIndex) {
	let containerElement = document.getElementById(containerElementID);
	if(containerElement.children.length >= 2) {
		if(containerElementIDs[containerElementID + "tabType"] === "nonSwipable") {
...
export function removeTab(containerElementID, tabIndex) {
	let containerElement = document.getElementById(containerElementID);
...
export function appendTabContent(containerElementID, tabIndex, elementObject) {
...
export function appendTabContentHTML(containerElementID, tabIndex, elementString) {
	containerElement = document.getElementById(containerElementID);
...
export function resizeTabElementsOnWindowResize() {
